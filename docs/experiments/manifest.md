...
| H6 Perturbation Phenotypes | `results/<batch>/h6/` | Do phenotype-inspired parameter variants separate first in precision dynamics, then behavior? | `configs/trust/hypotheses/h6_perturbation/perturbation_betrayal.toml`, `configs/trust/hypotheses/h6_perturbation/perturbation_dynamics.toml`, `configs/trust/hypotheses/h6_perturbation/affect_sensitivity.toml` | `analysis.configured` |
