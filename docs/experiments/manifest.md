...
| H6 Locality / Interference | `results/global_beta_locality_smoke_*/` | Does partner-local beta contain volatility better than a shared global beta tracker? | `configs/trust/hypotheses/h6_locality_interference/global_beta_smoke.toml` | standalone `scripts/analysis/analyze.py` |
