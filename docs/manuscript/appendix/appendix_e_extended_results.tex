...
These auxiliary controls vary the amplitude and stability of $\beta_k$ dynamics.

\begin{figure}[H]
\centering
\appendixfigure{fig_phenotype_dynamics_summary.pdf}
\caption{Perturbation controls in the graded decision regime. Low gain compresses the average within-episode max--min range of posterior mean $\bar{\beta}_k$, while a wider average within-episode max--min range of posterior mean $\bar{\beta}_k$ does not map monotonically to payoff.}
