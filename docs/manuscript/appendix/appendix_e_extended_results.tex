...
\begin{table}[H]
\centering
\caption{$\beta_k$ range by precision-gain $\alpha$ (betrayal regime).}
...
\caption{Precision-gain sweep across open graded and betrayal environments. Higher $\alpha$ expands $\beta_k$ range, while engagement, recovery, entropy, and payoff readouts vary non-monotonically. Precision gain therefore controls confidence-reactivity amplitude rather than mapping directly to reward.}
