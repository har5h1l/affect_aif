...
\caption{Precision-dynamics perturbations in the graded decision regime. Low gain compresses $\beta_k$ dynamics; wider $\beta_k$ movement does not produce monotonic payoff gains. Entropy values for the same variants are reported in Table~\ref{tab:perturbation_dynamics}.}
...
\subsection{Gain-prior profile quadrants}
