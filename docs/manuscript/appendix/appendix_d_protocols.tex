...
Unless otherwise stated, behavioral comparisons use 30 seeds per condition and profile sweeps use 20 seeds per condition. Episode lengths and replication counts are summarized in Table~\ref{tab:protocol_scales}.
