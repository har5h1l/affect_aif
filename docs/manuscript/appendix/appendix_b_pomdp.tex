...
The focal agent's stance-transition model uses the same investment-dependent interpolation form as the environment-side process in Appendix~\ref{app:process_stance}:
\[
