...
\end{align*}
\(s^{\mathrm{own}}\) indexes executed investment and is fully observable. The joint hidden state per partner spans \(4\times3\times6=72\) configurations.
...
\(B^{\mathrm{own}}\) deterministically records the executed investment:
\begin{equation}
