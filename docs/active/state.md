...
| Exp D Mixed Volatility | running as of June 3 16:11 PDT; partial checkpoint has 5/80 complete seed groups | Section 3.6.4 all `\resultp{}` | recovery running; not ready for interpretation |
