...
| Exp D Mixed Volatility | running as of June 3 15:38 PDT; partial checkpoint has 3/80 complete seed groups | Section 3.6.4 all `\resultp{}` | recovery running; not ready for interpretation |
