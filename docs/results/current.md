...
| H1 Model Fitness | Corrected smoke support; needs confirmation | The corrected post-fix log-surprisal smoke restores reliability-over-reward (`|r| = 0.976` vs `0.721`; partial `0.951` vs `0.172` controlling active payoff and encounter count). Treat H1 as a confirmation item before manuscript use. |
