...
\textbf{Model-fitness dissociation.} Partner-local correlations between $\beta_k$-derived precision and action surprisal versus realized payoff test whether the confidence signal tracks predictive reliability rather than partner value (Section~\ref{sec:model_fitness}).
