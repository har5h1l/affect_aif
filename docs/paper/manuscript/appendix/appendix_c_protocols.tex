...
\textbf{Precision-dynamics perturbations.} Computational profile variants (low-gain, high-gain, and cautious-prior profiles) perturb $\beta_k$ amplitude and stability in the graded decision regime (Appendix~\ref{app:extended_results}).
