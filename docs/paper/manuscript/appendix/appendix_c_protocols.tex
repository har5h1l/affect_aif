...
\textbf{Precision-dynamics perturbations.} Phenotype-inspired computational variants (alexithymia-like, borderline-like, depression-like) perturb $\beta_k$ amplitude and stability in the graded decision regime without claiming clinical validity (Appendix~\ref{app:extended_results}).
...
\item \textbf{H1 locality-probe confirmation}: replace focal-switch surprise--payoff correlation and aggregate payoff values with final 30-seed confirmation if they differ from current manuscript values.
