...
\bottomrule
\end{tabular}
\caption{Clinical sensitivity in Stag Hunt betrayal (50 seeds $\times$ 120 rounds). $d = (\text{phenotype} - \text{reference})/\text{SD}$; positive $d$ = phenotype outperforms reference. Borderline is the first phenotype with decisive Bayesian evidence of impairment relative to healthy.}
