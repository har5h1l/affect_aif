...
include/exclude rules live in `docs/paper/manuscript/results_digest.md`.
...
| "Does this generalize beyond scripted partners?" | Reciprocal AIF descriptive runs or benchmark follow-up. |
