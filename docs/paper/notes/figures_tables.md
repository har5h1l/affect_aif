...
Source docs: `docs/paper/notes/model_spec.md`, `docs/theory/pomdp_spec.md`,
`docs/design/implementation.md`.

### Figure 2: Model Fitness / Locality

Source table: `docs/paper/manuscript/source_tables/h1_model_fitness_confirm/`.

Output asset: `docs/paper/manuscript/figures/fig_model_fitness_beta_reward_divergence.pdf`
...
Output asset: `docs/paper/manuscript/figures/fig_deployment_social_summary.pdf`
...
Source table:
`docs/paper/manuscript/source_tables/h4_partner_choice_summary.csv` (5 seeds;
...
Source table: `docs/paper/manuscript/source_tables/h5_evidence_effect_summary.csv`
(regenerated from the 30-seed H5 confirmation).

Output asset: `docs/paper/manuscript/figures/fig_betrayal_boundary_summary.pdf`
...
Output asset: `docs/paper/manuscript/figures/fig_phenotype_dynamics_summary.pdf`
...
- `docs/paper/manuscript/figures/fig_alpha_sweep.pdf`
- `docs/paper/manuscript/figures/fig_phenotype_quadrants.pdf`
- `docs/paper/manuscript/figures/fig_forgiveness.pdf`
- `docs/paper/manuscript/figures/fig_mixed_volatility.pdf`
...
Paper-facing subset: `docs/paper/notes/experiment_manifest.md`.

### Table 3: Claims And Non-Claims

Use `docs/paper/notes/claims_and_evidence.md`. Useful for review and for
