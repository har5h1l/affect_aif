...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Custom batch root. Omit to use the canonical family layout from docs/guide/configs.md.",
    )
    parser.add_argument(
        "--batch-name",
        default=None,
        help="Custom batch subdirectory. Omit to use the canonical family layout from docs/guide/configs.md.",
    )
    parser.add_argument(
