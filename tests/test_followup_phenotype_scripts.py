...
from analysis.phenotypes.forgiveness import (
    EXP_C_BETA_TRAJECTORY_VARIANTS,
    EXP_C_PANELS,
    EXP_C_PROFILE_ORDER,
    _payoff_recovery,
)
...
from analysis.phenotypes.prior_factorial import EXP_B_PROFILE_ORDER
...
def test_exp_c_profile_order_drives_bar_panels_and_no_affect_has_no_beta_track():
    assert EXP_C_PROFILE_ORDER == (
        "cautious_high_alpha",
        "cautious_low_alpha",
        "default_reference",
        "naive_high_alpha",
...
def test_exp_b_profile_heatmap_uses_established_profile_order():
    assert EXP_B_PROFILE_ORDER == (
